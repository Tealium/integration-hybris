...
/**
 * This is the extension manager of the TealiumIQ extension.
 */
public class TealiumIQManager extends GeneratedTealiumIQManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TealiumIQManager.class.getName());
	 ...
	 */
	public static TealiumIQManager getInstance()
	{
		return (TealiumIQManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TealiumIQConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TealiumIQManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TealiumIQManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TealiumIQManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TealiumIQManager called, current tenant: " + getTenant().getTenantID());
		}
	}
